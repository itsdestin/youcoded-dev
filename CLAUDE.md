...
while the branch stays open. At the end of each session, Destin decides whether the
work is ready to merge — merge only on an explicit instruction, and never end a turn
suggesting it.
