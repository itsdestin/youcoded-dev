// Violation fixture for shell-session-no-claude-ui — the toast tells a shell session the native-runtime sentence.
...
export const toastFor = (command: string) => `${command} isn't available in this session.`;
