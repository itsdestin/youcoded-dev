// Violation fixture for shell-session-view-forced — the terminal pane reads the raw per-session map.
...
export const TermPane = () => <TerminalView visible={s.id === sessionId && viewModes.get(s.id) === 'terminal'} />;
