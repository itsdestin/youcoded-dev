// Violation fixture for shell-session-view-forced — the chat pane reads the raw per-session map.
...
export const ChatPane = () => <ChatView visible={s.id === sessionId && viewModes.get(s.id) === 'chat'} />;
