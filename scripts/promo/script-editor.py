...
SCREEN = {
    ...
    "Another kitty cat!": ("Describe a look.", "Kuromi Dreamer holds for two bars."),
    "Use any AI, cloud or local.": ("Your model, your call.", "The model list opens; Grok is picked 1.2 s later; the chip changes."),
    ...
    "Start a conversation on your computer, and resume on your phone.": ("Pick up on any device.", "The phone slides in with its session list, taps the session, and the chat is there."),
    "Same conversation, same files, synced automatically.": ("Pick up on any device.", "The chat on the phone; then its project files."),
