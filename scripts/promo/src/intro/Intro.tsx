...
export const introActions = (): Action[] => [
  A.peekIn(20, 30, GROUND_Y, SIZE, 0.82),         // peeks in over the left edge (the body is the middle half of the box, so most of the box must show)
  A.face(20, 'curious'),
  A.look(52, 8, 0.55, 0.1), A.look(66, 8, -0.4, -0.15), A.blink(78), A.look(82, 8, 0.2, 0),
  A.stepIn(88, 16, -18, GROUND_Y),                // steps fully into frame
  A.face(100, 'welcome'),
...
const Wordmark: React.FC = () => {
  ...
  // the jolt on impact: knocked right, springs back
...
export const Intro: React.FC<{ faceStyle?: FaceStyle; windowFile?: string }> = ({ faceStyle = 'classic', windowFile = 'promo-idle-cotton' }) => (
  <AbsoluteFill style={{ background: '#000' }}>
    ...
    <Sfx at={IMPACT + barFrame(1) + 36} name="pop" volume={0.4} />
  </AbsoluteFill>
);
