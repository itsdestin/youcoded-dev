# perf-lab 2026-09-11-0418-74e3977-master-74e3977a

sha 74e3977af8cb929255335ee1fb35f4f3c20f90e0 () — 2026-09-11T04:18:01.829Z
...
| idle PSS | — |
| idle CPU | — |
| switch, pane swapped (median of 3) | 87.8 ms / 219.7 ms p95 |
| **switch, messages on screen** | **117.9 ms / 243.6 ms p95** |
| switch into a 'huge' conversation (n=3, 60 entries of 60 expected) | 123.3 ms / 149.4 ms p95 |
| switch into a 'medium' conversation (n=3, 152 entries of 152 expected) | 115.8 ms / 191.9 ms p95 |
| switch into a 'small' conversation (n=3, 166 entries of 166 expected) | 116.3 ms / 147.3 ms p95 |
| switch into a 'empty' conversation (n=3, 0 entries of 0 expected) | 106.6 ms / 124.1 ms p95 |
| switch into a 'native' conversation (n=6, 1 entries) | 141 ms / 151.2 ms p95 |
| streamed into, during the switches | medium, small |
| long tasks | 50 tasks (4925 ms total, max 306 ms) |
| frame gaps > 40ms | 78 gaps (max 322 ms) |
| native first token | 1058 ms |
...
| CPU during workload | 660.3 % |
| PSS after workload | 1706.7 MB |

noise: load 2.86, busy 4.8%, worst accepted load 3.88 / busy 5.6%, discarded 4
