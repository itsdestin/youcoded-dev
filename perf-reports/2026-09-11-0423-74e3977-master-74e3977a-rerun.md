# perf-lab 2026-09-11-0423-74e3977-master-74e3977a-rerun

sha 74e3977af8cb929255335ee1fb35f4f3c20f90e0 () — 2026-09-11T04:23:47.903Z
...
| idle PSS | — |
| idle CPU | — |
| switch, pane swapped (median of 3) | 99 ms / 258.8 ms p95 |
| **switch, messages on screen** | **126.8 ms / 176.9 ms p95** |
| switch into a 'huge' conversation (n=3, 60 entries of 60 expected) | 126.8 ms / 140.4 ms p95 |
| switch into a 'medium' conversation (n=3, 152 entries of 152 expected) | 108.3 ms / 159.8 ms p95 |
| switch into a 'small' conversation (n=3, 166 entries of 166 expected) | 118.6 ms / 176.4 ms p95 |
| switch into a 'empty' conversation (n=3, 0 entries of 0 expected) | 143.5 ms / 158.9 ms p95 |
| switch into a 'native' conversation (n=6, 1 entries) | 121 ms / 176.9 ms p95 |
| streamed into, during the switches | medium, small |
| long tasks | 55 tasks (5931 ms total, max 321 ms) |
| frame gaps > 40ms | 96 gaps (max 347 ms) |
| native first token | 1037 ms |
| **layouts per streamed token (native)** | **stream-too-slow** — 32 layouts over 32 commits / 181 frames (0.177 /frame, 1 /commit) — ⚠ NOT a clean reading |
| CPU during workload | 709.8 % |
| PSS after workload | 1700 MB |

noise: load 2.99, busy 4.1%, worst accepted load 3.95 / busy 9.7%, discarded 50
