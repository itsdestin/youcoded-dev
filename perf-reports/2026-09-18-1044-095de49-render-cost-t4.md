# perf-lab 2026-09-18-1044-095de49-render-cost-t4

sha 095de4956d3c459e04a63fad07c7fb0c3d715852 (session/convo-tab-lag) — 2026-09-18T10:44:40.994Z
...
| idle PSS | — |
| idle CPU | — |
| projects.open to first cards / to counts (median of 3; 1600 files in 40 folders) | 153.4 ms / 153.5 ms |
| projects.search first key (flat flip) / keystroke median / p95 | 110 ms / 29.3 ms / 35.9 ms |
| projects.filter "Code & configs" -> flat grid | 97.6 ms for 831 cards, 4301 DOM nodes |
| projects.scroll flat grid | 40 screens, long tasks 0 ms total / max 0 ms, worst frame gap 0 ms, previews 0 img + 0 iframe |
| projects.list view | 98.1 ms |
| projects.switch big -> small / small -> big | 66.7 ms / 133.1 ms |
| projects.conversations tab | 58.6 ms |
| projects.tab thrash (Files <-> Conversations, rapid): to Files median / p95 / max | 64.8 ms / 65.5 ms / 65.5 ms; to Conversations median / max 65.1 ms / 66.2 ms; long tasks 0 ms, worst frame gap 0 ms, main process unresponsive 0 ms in total, worst IPC 6 ms |
| projects.reopen to first cards | 143.3 ms |
| projects long tasks | 51 ms total, max 51 ms |
| projects IPC stall (sum over steps) | 19 ms, max 68 ms, from 180 probe replies |

noise: load 3.91, busy 6.9%, worst accepted load 3.91 / busy 6.9%, discarded 0
