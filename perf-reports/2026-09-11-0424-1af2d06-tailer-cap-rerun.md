# perf-lab 2026-09-11-0424-1af2d06-tailer-cap-rerun

sha 1af2d06c181e1f7470a5eec1b06b15c68c84cc3f (perf/tailer-read-cap) — 2026-09-11T04:24:36.009Z
...
| idle PSS | — |
| idle CPU | — |
| switch, pane swapped (median of 3) | 96.8 ms / 251 ms p95 |
| **switch, messages on screen** | **163.4 ms / 314.1 ms p95** |
| switch into a 'huge' conversation (n=3, 60 entries of 60 expected) | 144 ms / 164.2 ms p95 |
| switch into a 'medium' conversation (n=3, 152 entries of 152 expected) | 154.6 ms / 214.1 ms p95 |
| switch into a 'small' conversation (n=3, 166 entries of 166 expected) | 241.7 ms / 314.1 ms p95 |
| switch into a 'empty' conversation (n=3, 0 entries of 0 expected) | 163.4 ms / 273.6 ms p95 |
| switch into a 'native' conversation (n=6, 1 entries) | 210.4 ms / 230 ms p95 |
| streamed into, during the switches | medium, small |
| long tasks | 54 tasks (5525 ms total, max 337 ms) |
| frame gaps > 40ms | 94 gaps (max 361 ms) |
| native first token | 1041 ms |
| **layouts per streamed token (native)** | **stream-too-slow** — 33 layouts over 33 commits / 181 frames (0.182 /frame, 1 /commit) — ⚠ NOT a clean reading |
| CPU during workload | 758.4 % |
| PSS after workload | 1683.7 MB |

noise: load 3.68, busy 9.2%, worst accepted load 3.68 / busy 9.3%, discarded 43
