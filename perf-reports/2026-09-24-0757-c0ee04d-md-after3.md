# perf-lab 2026-09-24-0757-c0ee04d-md-after3

sha c0ee04d540ee33b29a464890af7bf9d26e11e276 (session/perf-stream-markdown) — 2026-09-24T07:57:45.831Z
...
| idle PSS | — |
| idle CPU | — |
| **native-stream.visible: renderer main thread busy while a 3000 delta reply streams on screen at 150 /s** (median of 3; achieved 150 /s, 9780 chars shown) | **6879 ms (34.3 % of the window)**, script 3319.3 ms; long tasks 0 ms total / max 0 ms, worst frame gap 44 ms, 60 fps; verdict none |
| native-stream.visible commits / layouts over the stream | 1202 commits (1 /frame), 1206 layouts (1.002 /frame); turn 20064 ms |
| native-stream.visible IPC stall | 0 ms, max 8 ms, from 200 probe replies |
| **native-stream.switching: click -> messages on screen while it streams** (8 verified of 8 during the stream) | **86.4 ms / 136 ms p95**; into huge 94.1 ms, into the streaming one 54.3 ms; main thread busy 5630.5 ms (28.1 %), long tasks 51 ms |
| **native-stream.hidden: the visible window's main thread while the reply streams into a hidden session** | **1315.7 ms busy (6.1 %)**, long tasks 0 ms / max 0 ms, 0 commits in the visible pane, IPC stall 0 ms |

noise: load 3.97, busy 7.7%, worst accepted load 3.98 / busy 7.7%, discarded 44
