# perf-lab 2026-09-16-2335-128cf33-master-0916-baseline

sha 128cf3343e83ddf626f4cc7c840eb784576a5a78 (session/perf-baseline-20260916) — 2026-09-16T23:35:34.505Z
...
| idle PSS | — |
| idle CPU | — |
| switch, pane swapped (median of 3) | 45.1 ms / 105 ms p95 |
| **switch, messages on screen** | **80 ms / 144.7 ms p95** |
| switch into a 'huge' conversation (n=3, 60 entries of 60 expected) | 89 ms / 144.7 ms p95 |
| switch into a 'medium' conversation (n=3, 152 entries of 152 expected) | 53.3 ms / 61.4 ms p95 |
| switch into a 'small' conversation (n=3, 166 entries of 166 expected) | 52.4 ms / 88 ms p95 |
| switch into a 'empty' conversation (n=3, 0 entries of 0 expected) | 82.2 ms / 104.8 ms p95 |
| switch into a 'native' conversation (n=6, 1 entries) | 80.1 ms / 113 ms p95 |
| streamed into, during the switches | medium, small |
| long tasks | 16 tasks (1441 ms total, max 192 ms) |
| frame gaps > 40ms | 47 gaps (max 199 ms) |
| native first token | 1140 ms |
| **layouts per streamed token (native)** | **stream-too-slow** — 39 layouts over 41 commits / 181 frames (0.215 /frame, 1 /commit) — ⚠ NOT a clean reading |
| CPU during workload | 288.7 % |
| PSS after workload | 1675.8 MB |

noise: load 2.58, busy 7.1%, worst accepted load 3.08 / busy 7.1%, discarded 8
