# perf-lab 2026-09-24-0051-8277766-wl2-after

sha 82777660ca26dd72f4ec7cfd4fc9591425fa3808 (session/perf-many-tabs-20260923) — 2026-09-24T00:51:25.079Z
...
| idle PSS | — |
| idle CPU | — |
| switch, pane swapped (median of 5) | 44 ms / 161 ms p95 |
| **switch, messages on screen** | **97.3 ms / 183.2 ms p95** |
| switch into a 'huge' conversation (n=3, 60 entries of 60 expected) | 94.7 ms / 183.2 ms p95 |
| switch into a 'medium' conversation (n=3, 152 entries of 152 expected) | 121.9 ms / 156.9 ms p95 |
| switch into a 'small' conversation (n=3, 166 entries of 166 expected) | 124.4 ms / 138.1 ms p95 |
| switch into a 'empty' conversation (n=3, 0 entries of 0 expected) | 78.2 ms / 94.2 ms p95 |
| switch into a 'native' conversation (n=6, 1 entries) | 79 ms / 107.9 ms p95 |
| streamed into, during the switches | medium, small |
| long tasks | 24 tasks (2171 ms total, max 191 ms) |
| frame gaps > 40ms | 33 gaps (max 202 ms) |
| native first token | 2449 ms |
| **layouts per streamed token (native)** | **stream-too-slow** — 40 layouts over 42 commits / 181 frames (0.221 /frame, 0.955 /commit) — ⚠ NOT a clean reading |
| CPU during workload | 279.5 % |
| PSS after workload | 1617.6 MB |

noise: load 3.91, busy 4.9%, worst accepted load 3.93 / busy 5.6%, discarded 24
