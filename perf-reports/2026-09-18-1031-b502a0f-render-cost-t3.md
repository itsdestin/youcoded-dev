# perf-lab 2026-09-18-1031-b502a0f-render-cost-t3

sha b502a0f7360fd08419993fe7ebea056211dc5585 (session/convo-tab-lag) — 2026-09-18T10:31:36.952Z
...
| idle PSS | — |
| idle CPU | — |
| projects.open to first cards / to counts (median of 3; 1600 files in 40 folders) | 161.6 ms / 161.6 ms |
| projects.search first key (flat flip) / keystroke median / p95 | 197 ms / 26.1 ms / 37 ms |
| projects.filter "Code & configs" -> flat grid | 98.7 ms for 831 cards, 4301 DOM nodes |
| projects.scroll flat grid | 40 screens, long tasks 0 ms total / max 0 ms, worst frame gap 0 ms, previews 0 img + 0 iframe |
| projects.list view | 113.1 ms |
| projects.switch big -> small / small -> big | 66.3 ms / 314 ms |
| projects.conversations tab | 174.8 ms |
| projects.tab thrash (Files <-> Conversations, rapid): to Files median / p95 / max | 61.5 ms / 109.8 ms / 109.8 ms; to Conversations median / max 165.9 ms / 186.2 ms; long tasks 907 ms, worst frame gap 151 ms, main process unresponsive 0 ms in total, worst IPC 15 ms |
| projects.reopen to first cards | 165.4 ms |
| projects long tasks | 1124 ms total, max 134 ms |
| projects IPC stall (sum over steps) | 69 ms, max 95 ms, from 183 probe replies |

noise: load 3.94, busy 2.8%, worst accepted load 3.94 / busy 2.8%, discarded 11
