# perf-lab 2026-08-28-1129-1c7b830-st-folding

sha 1c7b830b9c33cc8e3632332599223b3a2e672688 (perf/evict-offscreen-turns) — 2026-08-28T11:29:53.070Z
...
| idle PSS | — |
| idle CPU | — |
| stall.small (median of 3, 3 stabilized) | worst freeze 70 ms · total 0 ms · main 0 ms / renderer 0 ms — none |
| stall.medium (median of 3, 3 stabilized) | worst freeze 35 ms · total 0 ms · main 0 ms / renderer 0 ms — none |
| stall.huge (median of 3, 3 stabilized) | worst freeze 11 ms · total 0 ms · main 0 ms / renderer 0 ms — none |

noise: load 1.56, busy 1.8%, worst accepted load 1.56 / busy 1.8%, discarded 0
...
- small: small#0: the stall probe was itself blocked for up to 375ms (it pings every 100ms), so it could not sample during that time. ipcTotalStallMs is a FLOOR, not a total, and the attribution is drawn from a pool that systematically misses renderer blocking — it OVERSTATES the main process.
