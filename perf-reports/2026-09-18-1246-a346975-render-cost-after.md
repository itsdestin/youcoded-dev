# perf-lab 2026-09-18-1246-a346975-render-cost-after

sha a346975ea73f3336977f61b1eb3c32b4795687fe (session/convo-tab-lag) — 2026-09-18T12:46:25.708Z
...
| idle PSS | — |
| idle CPU | — |
| projects.open to first cards / to counts (median of 3; 1600 files in 40 folders) | 123.9 ms / 124.1 ms |
| projects.search first key (flat flip) / keystroke median / p95 | 46 ms / 29.6 ms / 39.9 ms |
| projects.filter "Code & configs" -> flat grid | 65.8 ms for 50 cards, 397 DOM nodes |
| projects.scroll flat grid | 40 screens, long tasks 0 ms total / max 0 ms, worst frame gap 0 ms, previews 0 img + 0 iframe |
| projects.list view | 64.1 ms |
| projects.switch big -> small / small -> big | 66.9 ms / 136.8 ms |
| projects.conversations tab | 58.4 ms |
| projects.tab thrash (Files <-> Conversations, rapid): to Files median / p95 / max | 64 ms / 65.5 ms / 65.5 ms; to Conversations median / max 65.3 ms / 65.7 ms; long tasks 0 ms, worst frame gap 0 ms, main process unresponsive 0 ms in total, worst IPC 6 ms |
| projects.reopen to first cards | 129.6 ms |
| projects long tasks | 0 ms total, max 0 ms |
| projects IPC stall (sum over steps) | 15 ms, max 61 ms, from 174 probe replies |

noise: load 2.59, busy 2.6%, worst accepted load 2.59 / busy 2.6%, discarded 0
