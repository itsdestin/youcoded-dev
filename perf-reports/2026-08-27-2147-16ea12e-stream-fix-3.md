# perf-lab 2026-08-27-2147-16ea12e-stream-fix-3

sha 16ea12eb8b315f876860cee89348cac1599b2dac (perf/optimization-pass) — 2026-08-27T21:47:23.721Z
...
| idle PSS | — |
| idle CPU | — |
| switch, pane swapped (median of 3) | 4780.5 ms / 11131.8 ms p95 |
| **switch, messages on screen** | **4780.7 ms / 18033.5 ms p95** |
| switch into a 'huge' conversation (n=3, 7000 entries of 7000 expected) | 12932 ms / 17638.9 ms p95 |
| switch into a 'medium' conversation (n=3, 8418 entries of 5764 expected) | 11876.2 ms / 11882.3 ms p95 |
| switch into a 'small' conversation (n=3, 3666 entries of 1108 expected) | 4800.2 ms / 5016.3 ms p95 |
| switch into a 'empty' conversation (n=3, 0 entries of 0 expected) | 3535.2 ms / 3795.8 ms p95 |
| switch into a 'native' conversation (n=6, 2 entries) | 2816.3 ms / 3052.9 ms p95 |
| streamed into, during the switches | medium, small |
| long tasks | 255 tasks (326440 ms total, max 13013 ms) |
| frame gaps > 40ms | 206 gaps (max 13403 ms) |
| native first token | 6446 ms |
| CPU during workload | 175.8 % |
| PSS after workload | 7447.6 MB |

noise: load 0.51, busy 2.7%, worst accepted load 0.51 / busy 2.7%, discarded 0
