# perf-lab 2026-09-03-2023-f39c742-ab-folding-rootfix

sha f39c7420fa1a7cdc0ebc185908a3014447fa2010 (perf/evict-offscreen-turns) — 2026-09-03T20:23:23.886Z
...
noise: load 2.29, busy 2.3%, worst accepted load 2.29 / busy 2.3%, discarded 0
...
| what | value |
|---|---|
| PSS floor -> ceiling | 1494.8 MB -> 1783.8 MB (**+283.1 MB**) |
| JS share (only EVICTION frees) | 64.3 MB live … 97.8 MB committed |
| non-JS share: DOM/layout/paint (PARKING frees), lower bound | 197.3 MB |
| DOM nodes floor -> ceiling | 23445 -> 17097 (+-6348) |
| event listeners floor -> ceiling | 869 -> 584 (+-285) |
| released by switching away + GC | 10.1 MB |
| pages loaded / entries added | 200 / 11920 |

| conversation | pages | entries after | page median / p95 | PSS after | reached the top every run |
|---|---|---|---|---|---|
| huge | 116 | 7000 | 429 ms / 740 ms | 3834.1 MB | yes |
| medium | 83 | 5000 | 384 ms / 610 ms | 3763 MB | yes |
| small | 1 | 100 | 158 ms / 158 ms | 3737.4 MB | yes |
