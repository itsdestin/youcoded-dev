# perf-lab 2026-09-18-1056-4b20680-render-cost-t5

sha 4b206809de0927e1ff79abdebc30eb4db2b20906 (session/convo-tab-lag) — 2026-09-18T10:56:23.267Z
...
| projects.search first key (flat flip) / keystroke median / p95 | 86 ms / 21.7 ms / 34 ms |
| projects.filter "Code & configs" -> flat grid | 64.7 ms for 50 cards, 397 DOM nodes |
| projects.scroll flat grid | 40 screens, long tasks 0 ms total / max 0 ms, worst frame gap 0 ms, previews 0 img + 0 iframe |
| projects.list view | 63.7 ms |
| projects.switch big -> small / small -> big | 66.8 ms / 164.5 ms |
| projects.conversations tab | 58.6 ms |
| projects.tab thrash (Files <-> Conversations, rapid): to Files median / p95 / max | 63.7 ms / 64.8 ms / 64.8 ms; to Conversations median / max 65.2 ms / 66.7 ms; long tasks 0 ms, worst frame gap 0 ms, main process unresponsive 0 ms in total, worst IPC 6 ms |
| projects.reopen to first cards | 132.4 ms |
| projects long tasks | 0 ms total, max 0 ms |
| projects IPC stall (sum over steps) | 71 ms, max 86 ms, from 177 probe replies |

noise: load 3, busy 1.2%, worst accepted load 3 / busy 1.2%, discarded 0
