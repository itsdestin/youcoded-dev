...
| [local-models](docs/roadmap/local-models.md) — getting a model onto this machine and serving it | 15 | 3 | 3 | 2 |
| [remote-access](docs/roadmap/remote-access.md) — reaching the app from another device | 14 | 5 | 0 | 2 |
