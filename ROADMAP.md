...
|---|---|---|---|---|
| [dev-workspace](docs/roadmap/dev-workspace.md) — building the app, not the app | 108 | 33 | 6 | 10 |
...
| [sync](docs/roadmap/sync.md) — moving your stuff between devices | 23 | 7 | 8 | 5 |
