...
| [native-harness](docs/roadmap/native-harness.md) — the app's own agent doing work | 59 | 10 | 3 | 19 |
| [user-interface](docs/roadmap/user-interface.md) — shared primitives, chrome, layout, copy | 32 | 16 | 0 | 6 |
