...
|---|---|---|---|---|
| [dev-workspace](docs/roadmap/dev-workspace.md) — building the app, not the app | 79 | 31 | 2 | 10 |
...
| [themes](docs/roadmap/themes.md) — how the app looks under a theme | 9 | 3 | 0 | 2 |
