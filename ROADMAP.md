...
|---|---|---|---|---|
| [dev-workspace](docs/roadmap/dev-workspace.md) — building the app, not the app | 71 | 27 | 2 | 9 |
| [native-harness](docs/roadmap/native-harness.md) — the app's own agent doing work | 51 | 9 | 1 | 16 |
