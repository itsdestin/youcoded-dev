...
| [native-harness](docs/roadmap/native-harness.md) — the app's own agent doing work | 57 | 10 | 5 | 23 |
| [user-interface](docs/roadmap/user-interface.md) — shared primitives, chrome, layout, copy | 40 | 17 | 2 | 6 |
