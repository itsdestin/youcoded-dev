...
|---|---|---|---|---|
| [dev-workspace](docs/roadmap/dev-workspace.md) — building the app, not the app | 91 | 29 | 2 | 10 |
...
| [files](docs/roadmap/files.md) — documents the user opens, edits or organises | 26 | 8 | 0 | 9 |
