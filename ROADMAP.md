...
| [chat-data](docs/roadmap/chat-data.md) — everything kept about a chat | 24 | 8 | 2 | 2 |
...
| [claude-code-integration](docs/roadmap/claude-code-integration.md) — the app steering Claude Code's terminal | 15 | 7 | 1 | 4 |
