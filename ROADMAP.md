...
|---|---|---|---|---|
| [dev-workspace](docs/roadmap/dev-workspace.md) — building the app, not the app | 65 | 25 | 1 | 8 |
| [native-harness](docs/roadmap/native-harness.md) — the app's own agent doing work | 48 | 7 | 1 | 16 |
...
| [local-models](docs/roadmap/local-models.md) — getting a model onto this machine and serving it | 5 | 0 | 0 | 2 |
