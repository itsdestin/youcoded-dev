...
- **Reviewing UI or showing a before/after? `bash scripts/ui-review/run-review.sh <worktree>`** — every surface × 6 themes, each shot self-verified; `coverage.md` names what did NOT open (cite it). Standard: `docs/active/design/2026-08-25-ui-design-guide.md`; procedure: `/ui-review`; docs: `scripts/ui-review/README.md`. A new workbench switch needs a boot-check route AND a plan entry.
