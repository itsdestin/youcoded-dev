...
| Prerequisite installer | `youcoded/desktop/src/main/prerequisite-installer.ts`<br>`youcoded/desktop/src/main/first-run.ts` | prereq-installer | `youcoded/docs/cc-dependencies.md` | `youcoded/desktop/tests/prerequisite-installer-pins.test.ts` + manual (clean Windows box) |
