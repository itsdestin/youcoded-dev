...
| `tests/animation-frame-budget.test.ts` | CSS/inline animations carry steps(), no unbudgeted infinite | A, G | split (CSS sweeps keep, TSX sweeps ast-grep) | `no-unstepped-infinite-animation` | 45/45 |
