...
| `tests/arcade-authority.test.ts` | Game files avoid attention APIs, palette classes, shared state | M, D, A | split (keep registry-shape cases) | `arcade-no-forbidden-attention-apis` | 13/17 |
