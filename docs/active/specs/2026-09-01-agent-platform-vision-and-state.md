...
| # | Step | State |
|---|---|---|
| 3 | **Session context transparency panel** (broadened from "tell the user what was truncated") | Design approved 2026-08-17, reworded + restyled and re-approved 2026-09-09 on `session/context-truncation` (rebased onto master); **backend unbuilt** (`native.onSessionContext` does not exist). Handoff: `docs/active/handoffs/2026-09-09-session-context-panel-handoff.md` |
