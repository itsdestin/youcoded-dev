...
contract `docs/active/design/2026-09-09-remote-access/remote-access.contract.json`,
...
- **R2-1 — §6 contradicts the signed UI contract on the one behaviour the contract — **accepted**
  ...
  (`docs/active/design/2026-09-09-remote-access/remote-access.contract.json`,
