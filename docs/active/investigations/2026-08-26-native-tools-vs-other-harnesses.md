...
> **Status 2026-08-28.** Destin picked batches A, B and C plus PDF reading; all shipped the same day — youcoded PRs **#352** (D-2, G-7), **#353** (D-1, D-3, D-4, D-5, D-6, G-4, G-5, G-10, G-11, G-12, G-13, T-3) and **#354** (G-6). **G-2** (Other + note on question cards) is built on `feat/ask-question-other` and awaiting Destin's deck answers. **G-3** waits on an evaluator measurement now that the G-4 wording is live. Still open, each with a ROADMAP entry: **G-1** (background execution), **G-3**, **G-8**, **G-9**, **T-1/T-2**; **G-14** stays documented-and-accepted; **D-7** was fixed 2026-08-26, **D-8** is ROADMAP #133.
