...
- **Conceptual reframe applied this session:** "the toolkit" retired across canonical docs; `youcoded-core` now described as one of a handful of bundled plugins (and being deprecated per `docs/active/plans/2026-04-21-deprecate-youcoded-core.md`)
