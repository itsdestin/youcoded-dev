...
**Parent:** `2026-07-09-platform-vision-roadmap.md` (Phase 2, §3.3). Builds on the shipped Phase 1 spec (`docs/archive/specs/2026-07-10-phase1-engine-providers-design.md`) and the Phase 0 research report `docs/archive/investigations/2026-07-10-harness-design-ideas.md`, which supplies the design vocabulary used throughout (cited as "R§n").
...
6. **WebSearch default is the Exa keyless endpoint**, with DDG HTML-scrape fallback and keyed upgrades (Tavily; Exa key lifts limits on the same endpoint). Chain order ships as data, trivially patchable — the research's core warning is that free search endpoints keep vanishing (Brave free tier dead Feb 2026, Bing API dead Aug 2025). Full comparison + citations: `docs/archive/investigations/2026-07-15-web-search-backends.md`. Brave is deliberately NOT in v1.
